...
class InheritedJoinTest(fixtures.MappedTest, AssertsCompiledSQL):
    ...
    def test_single_prop(self):
        ...
        self.assert_compile(
            ...
            "FROM companies JOIN people ON companies.company_id = people.company_id", use_default_dialect=True
        )
    ...
    def test_single_prop_of_type(self):
        ...
        self.assert_compile(
            ...
            "ON companies.company_id = people.company_id", use_default_dialect=True
        )
    ...
    def test_prop_with_polymorphic_2(self):
        ...
        self.assert_compile(
            ...
            "WHERE paperwork_1.description LIKE :description_1 ORDER BY people.person_id", use_default_dialect=True
        )
    ...
    def test_explicit_polymorphic_join_one(self):
        ...
        self.assert_compile(
            ...
            "WHERE engineers.engineer_name = :engineer_name_1", use_default_dialect=True
        )
    ...
    def test_multiple_adaption(self):
        ...
        self.assert_compile(
            ...
            "people.company_id WHERE people.name = :name_1", use_default_dialect=True
        )
        ...
        self.assert_compile(
            ...
            "WHERE people.name = :name_1 AND anon_1.name = :name_2", use_default_dialect=True
        )
...
class MultiplePathTest(fixtures.MappedTest, AssertsCompiledSQL):
    ...
    def test_basic(self):
        ...
        self.assert_compile(
            ...
            "ON t1.id = t1t2_2_1.t1id JOIN t2 ON t2.id = t1t2_2_1.t2id WHERE t2.id = :id_1", use_default_dialect=True
        )
